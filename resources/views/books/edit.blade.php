                         ...
                         <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titulo" class="form-control" value="{{$book->titulo}}">
                                </div>
                            </div>
                             <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Autores:</strong>
                                    <input type="text" name="autores" class="form-control" value="{{$book->autores}}">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="descripcion">{{$book->descripcion}}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12 alert alert-info">
                                Si no desea reemplazar los archivos, no debe de subir uno nuevo; estos se mantienen.
                            </div>
